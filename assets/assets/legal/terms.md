...
* related insights and support features

## Accounts

You are responsible for maintaining access to your account and for activity performed using your account credentials.
...
When you use group features, information you add to shared groups may be visible to members of those groups based on app functionality.
...
We may also update these Terms. For major updates, we may require you to review and accept the updated version before continuing to use the app.
